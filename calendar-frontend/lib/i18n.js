...
export const TRANSLATIONS = {
    vi: {
        ...
        connected_calendars_title: "Lịch kết nối",
        ...
        help_desc: "Hướng dẫn & Liên hệ hỗ trợ",
        support: {
            ...
            message: "Nội dung",
            message_placeholder: "Vui lòng mô tả chi tiết vấn đề bạn gặp phải...",
            submit: "Gửi yêu cầu",
            sending: "Đang gửi...",
        ...
        cancel: "Huỷ",
        saved: "Đã lưu",
        auto_saved_desc: "Thay đổi được lưu tự động",
        syncing_settings: "Đang đồng bộ cài đặt...",
        settings_synced: "Đã đồng bộ cài đặt",
        settings_sync_error: "Không thể đồng bộ cài đặt. Kiểm tra kết nối.",
        ...
        user: {
            ...
            login_prompt_title: "Vui lòng đăng nhập để sử dụng ứng dụng",
            login_prompt_desc: "Nhấp vào bất kỳ đâu để đăng nhập",
            ...
            enter_email_recover: "Nhập email của bạn để nhận hướng dẫn đặt lại mật khẩu.",
            full_name: "Họ và tên",
            enter_name: "Nhập tên của bạn",
            min_length_pass: "Tối thiểu 6 ký tự",
        ...
        contacts_panel: {
            ...
            view_only: "Chỉ xem",
            owned_by: "Người tạo",
            leave_event: "Rời khỏi sự kiện",
            collision_warning: "Sự kiện này đang trùng lịch với các mục khác của bạn. Vui lòng kiểm tra và điều chỉnh lại lịch trình trước khi chấp nhận.",
            collision_found: "Trùng lịch",
            no_notifications: "Không có thông báo mới",
            invitation_msg: "%s đã mời bạn tham gia sự kiện: %s",
            friend_request_title: "Lời mời kết nối",
            friend_accepted_title: "Kết nối thành công",
            clear_all: "Xoá hết",
            confirm_delete_all_notifs: "Bạn có chắc chắn muốn xoá tất cả thông báo?",
        ...
        create_modal: {
            ...
            location_placeholder: "Thêm vị trí",
            description_placeholder: "Thêm mô tả",
            note_placeholder: "Ghi chú thêm",
            task_details_placeholder: "Chi tiết công việc",
            attach_file: "Đính kèm tệp",
            upload: "Tải lên",
            title_required: "Tiêu đề không được để trống",
            deadline: "Hạn chót",
            no_deadline: "Chưa thiết lập hạn chót",
            change_datetime: "Đổi ngày/giờ",
            collapse: "Thu gọn",
            confirm_trash: "Đưa vào thùng rác? Mục này sẽ tự động xoá vĩnh viễn sau 30 ngày.",
        ...
        notif_settings: {
            ...
            app_desc: "Hiển thị thông báo bên trong ứng dụng",
            email: "Thông báo qua email",
            email_desc: "Gửi email thông báo đến hộp thư của bạn",
            both: "Cả hai",
            both_desc: "Nhận cả thông báo trong app và email",
        ...
        view_options: {
            title: "Tuỳ chọn xem",
            theme: "Giao diện",
            theme_desc: "Chọn chế độ sáng, tối hoặc theo hệ thống",
            theme_light: "Sáng",
            theme_dark: "Tối",
            ...
            show_declined: "Hiện sự kiện đã từ chối",
            show_declined_desc: "Hiển thị mờ các sự kiện bạn đã từ chối tham gia",
            show_friends_calendars: "Hiện lịch của người đã kết nối",
            show_friends_calendars_desc: "Hiển thị sự kiện từ những người đã kết nối",
    ...
    en: {
        ...
        connected_calendars_title: "Connected Calendars",
        ...
        trash: "Trash",
        help: "Help & Support",
        help_desc: "Guide & Contact Support",
        support: {
            title: "Help & Support",
            type: "Request Type",
            subject: "Subject",
        ...
        cancel: "Cancel",
        saved: "Saved",
        auto_saved_desc: "Changes are saved automatically",
        syncing_settings: "Syncing settings...",
        settings_synced: "Settings synced",
        settings_sync_error: "Couldn't sync settings. Check your connection.",
        sync_now: "Sync now",
        ...
        notif_settings: {
            ...
            app_desc: "Show notifications within the application",
            email: "Email notifications",
            email_desc: "Send email notifications to your inbox",
            both: "Both",
            both_desc: "Receive both in-app and email notifications",
        ...
        view_options: {
            title: "View Options",
            theme: "Appearance",
            theme_desc: "Choose light, dark, or system default theme",
            theme_light: "Light",
            theme_dark: "Dark",
            theme_system: "System",
            ...
            show_declined: "Show declined events",
            show_declined_desc: "Show dimmed events you have declined",
            show_friends_calendars: "Show friends' calendars",
            show_friends_calendars_desc: "Display events from connected people",
        ...
        user: {
            ...
            login_prompt_title: "Please login to use the application",
            login_prompt_desc: "Click anywhere to login",
            ...
            enter_email_recover: "Enter your email to receive password reset instructions.",
            full_name: "Full Name",
            enter_name: "Enter your name",
            min_length_pass: "Minimum 6 characters",
        ...
        profile: {
            ...
            currentPasswordPlaceholder: "Enter current password to confirm",
        ...
        contacts_panel: {
            ...
            collision_warning: "This event conflicts with your existing schedule. Please resolve the conflict before accepting.",
            collision_found: "Schedule Conflict",
            no_notifications: "No new notifications",
            invitation_msg: "%s invited you to event: %s",
            friend_request_title: "Friend Request",
            friend_accepted_title: "Connection Successful",
            clear_all: "Clear all",
            confirm_delete_all_notifs: "Are you sure you want to delete all notifications?",
        ...
        create_modal: {
            ...
            task_details_placeholder: "Task details",
            attach_file: "Attach file",
            upload: "Upload",
            title_required: "Title cannot be empty",
            deadline: "Deadline",
            no_deadline: "No deadline set",
            change_datetime: "Edit date/time",
            collapse: "Collapse",
            confirm_trash: "Move to trash? This item will be permanently deleted after 30 days.",
