...
import { Calendar as CalendarIcon, Clock, Link, MapPin, AlignLeft, Paperclip, Palette, Tag, X } from 'lucide-react';
...
export default function EventForm({ now, duration, onSave, initialData = null }) {
    ...
    // Cập nhật form khi kéo thả/thay đổi kích thước bên ngoài (chỉ khi không editing)
    useEffect(() => {
