        ...
        <div id="section-categories" className="space-y-6 scroll-mt-6 pb-20">
            ...
            <Card>
                <div className="px-5 py-4">
                    ...
                    <p className="text-xs text-slate-400 dark:text-white mb-4">{t('categories_settings.add_desc', lang)}</p>
                    ...
                    <p className="text-[10px] font-bold text-slate-400 dark:text-white uppercase tracking-widest mb-3">{t('sections.category_list', lang)} ({categories.length})</p>
