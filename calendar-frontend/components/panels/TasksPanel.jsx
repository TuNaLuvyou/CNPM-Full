  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#2d2d2d]">
      ...
      <div className="px-3 py-2 border-b border-slate-100 dark:border-[#484848]">
        <div className="flex items-center gap-2 bg-slate-50 dark:bg-[#1f1f1f] rounded-lg px-3 py-2 border border-transparent focus-within:border-blue-300 transition-colors">
          <Plus className="w-4 h-4 text-slate-400 dark:text-[#9e9e9e] flex-shrink-0" />
          <input
            value={newTask}
        ...
        {loading ? (
          <div className="flex items-center justify-center h-32 gap-2 text-slate-400 dark:text-[#9e9e9e]">
            ...
            <div className="flex flex-col items-center justify-center h-48 text-slate-400 dark:text-[#9e9e9e] gap-2 px-6 text-center">
              ...
              <p className="text-[10px] text-slate-400 dark:text-[#9e9e9e]">Bạn cần đăng nhập để quản lý công việc và đồng bộ hóa.</p>
            </div>
        ) : error ? (
            ...
            {done.length > 0 && appSettings.showCompletedTasks !== false && (
              <>
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2 text-xs text-slate-500 dark:text-[#9e9e9e] font-semibold hover:bg-slate-50 dark:hover:bg-[#2d2d2d] border-t border-slate-100 dark:border-[#484848] transition sticky top-0 bg-white dark:bg-[#2d2d2d]"
                >
