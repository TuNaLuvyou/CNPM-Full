    ...
    if (validating) {
        return (
            <div className="flex flex-col items-center justify-center py-10 gap-3">
                ...
                <span className="text-sm text-slate-500 font-medium animate-pulse">Đang xác thực liên kết...</span>
            </div>
        );
    }
    ...
    if (validationError) {
        return (
            <div className="text-center py-6 animate-in fade-in zoom-in duration-300">
                ...
                <p className="text-slate-500 text-sm mb-6 max-w-xs mx-auto font-medium">{validationError}</p>
                <button
                    onClick={() => router.push('/')}
    ...
    if (success) {
        return (
            <div className="text-center py-6 animate-in fade-in zoom-in duration-300">
                ...
                <h2 className="text-2xl font-bold text-slate-800 mb-2">Đổi mật khẩu thành công!</h2>
                <p className="text-slate-500 text-sm mb-6 font-medium">Mật khẩu đã được thay đổi. Đang chuyển hướng về trang chủ...</p>
            ...
            <div>
                ...
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 placeholder-slate-400 outline-none transition"
                    />
            ...
            <div>
                ...
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-10 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 placeholder-slate-400 outline-none transition"
                    />
                    <Lock className="w-5 h-5 text-slate-500 absolute left-3 top-3.5" />
                </div>
            </div>
...
export default function ResetPasswordPage() {
    return (
        <div className="min-h-screen bg-slate-50 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-50 via-slate-50 to-indigo-50 flex items-center justify-center p-6 relative overflow-hidden">
            {/* Background elements */}
            ...
            <div className="relative w-full max-w-md bg-white/80 backdrop-blur-md rounded-3xl border border-white/60 shadow-2xl p-8 md:p-10">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">Lịch Cá Nhân</h1>
                    <p className="text-sm text-slate-500 mt-2 font-medium">Đặt lại mật khẩu cho tài khoản của bạn</p>
                </div>

                <Suspense fallback={
                    <div className="flex flex-col items-center justify-center py-10 gap-3">
                        <Loader2 className="w-8 h-8 animate-spin text-blue-600" />
                        <span className="text-sm text-slate-500 font-medium">Đang tải biểu mẫu...</span>
                    </div>
                }>
                    <ResetPasswordForm />
                </Suspense>
